...
#
# Here we do the 3 Myr estimate (Sigma_c=200g/cm^2)
#
...
tstart = 1e3*year
tend   = 3e6*year   # Stellar age assumption (See P&MC Section 2)
...
sigc   = 200.       # Estimate from P&MC (Their page 6, top left col)
